...
public class ControllerFornecedor implements Initializable {
	...
	private void bt_Novo_Selected(ActionEvent event) throws IOException {
		...
		lb_Titulo.setText("Fornecedores - Novo");
	...
	private void bt_Alterar_Selected(ActionEvent event) throws IOException {
		...
		lb_Titulo.setText("Fornecedores - Alterar");
	...
	private void bt_Consultar_Selected(ActionEvent event) throws IOException {
		...
		lb_Titulo.setText("Fornecedores - Consulta");
		visibilidadeBusca(true);
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		// initialize Pane
		assert pn_Fornecedores != null : "fx:id=\"pn_Fornecedores\" was not injected: check your FXML file 'Cliente.fxml'.";
		// initialize Label
